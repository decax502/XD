...
-- ==================================================================
-- 17. ESP SYSTEM PREMIUM (HIGHLIGHTS + TEAM CHECK)
-- ==================================================================
...
local function UpdateESP()
    ...
    for _, p in pairs(Players:GetPlayers()) do
        if p ~= LocalPlayer and p.Character and p.Character:FindFirstChild("HumanoidRootPart") and p.Character:FindFirstChild("Humanoid") and p.Character.Humanoid.Health > 0 then
            ...
            -- Crear Nombre y Distancia (BillboardGui)
...
-- Actualizar el ESP constantemente
RunService.RenderStepped:Connect(function()
    if isESPActive then
...
-- Bucle lento para agregar/quitar jugadores
task.spawn(function()
...
AddCmd("esp", "Abre el panel del ESP", function() ESPMain.Visible = true; LogMessage("Menú ESP abierto.", tPurple) end)
