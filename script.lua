...
local function UpdateESP()
    ...
    for _, p in pairs(Players:GetPlayers()) do
        if p ~= LocalPlayer and p.Character and p.Character:FindFirstChild("HumanoidRootPart") and p.Character:FindFirstChild("Humanoid") and p.Character.Humanoid.Health > 0 then
            ...
            -- Team Check Logic
            if useTeamCheck and p.Team == LocalPlayer.Team then
                continue
            end
            ...
            -- Highlight nativo (Wallhack sin lag)
...
local function ToggleESP()
    ...
    if isESPActive then
        ESPToggleBtn.BackgroundColor3 = tCyan; ESPToggleBtn.TextColor3 = Color3.fromRGB(10, 10, 10); ESPToggleBtn.Text = "ESP: ON"
        UpdateESP()
    else
        ESPToggleBtn.BackgroundColor3 = Color3.fromRGB(30, 30, 30); ESPToggleBtn.TextColor3 = tWhite; ESPToggleBtn.Text = "ESP: OFF"
        ClearESP()
    end
end
...
ESPTeamBtn.MouseButton1Click:Connect(function()
    ...
    if useTeamCheck then
        ESPTeamBtn.BackgroundColor3 = tGreen; ESPTeamBtn.TextColor3 = Color3.fromRGB(10, 10, 10); ESPTeamBtn.Text = "TEAM CHECK: ON"
    else
        ESPTeamBtn.BackgroundColor3 = Color3.fromRGB(40, 40, 40); ESPTeamBtn.TextColor3 = tWhite; ESPTeamBtn.Text = "TEAM CHECK: OFF"
    end
    if isESPActive then UpdateESP() end
end)
...
-- MANEJADOR DE KEYBIND AISLADO
ESPKeyBtn.MouseButton1Click:Connect(function()
    if espKeybind ~= nil then 
        espKeybind = nil; ESPKeyBtn.Text = "KEY"; ESPKeyBtn.BackgroundColor3 = Color3.fromRGB(40, 40, 40); isEspBinding = false
    else 
        isEspBinding = true; ESPKeyBtn.Text = "..."; ESPKeyBtn.BackgroundColor3 = tOrange 
    end
end)
...
UserInputService.InputBegan:Connect(function(input, gp)
    ...
    if not gp and espKeybind and input.KeyCode == espKeybind and not UserInputService:GetFocusedTextBox() then
        ToggleESP()
    end
end)

-- ==================================================================
-- 16. SERVER HOPPER & FAST REJOIN
-- ==================================================================
...
-- Comando para abrir el menú del ESP
AddCmd("esp", "Abre el panel del ESP System", function() 
    ESPMain.Visible = true; LogMessage("Menú ESP abierto.", tPurple) 
end)
