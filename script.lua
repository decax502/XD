...
ReverseToggleBtn = Instance.new("TextButton", ReverseMain); ReverseToggleBtn.Size = UDim2.new(1, -75, 0, 45); ReverseToggleBtn.Position = UDim2.new(0, 10, 0, 45); ReverseToggleBtn.BackgroundColor3 = Color3.fromRGB(30, 30, 30); ReverseToggleBtn.Text = "REVERSE: OFF"; ReverseToggleBtn.TextColor3 = tWhite; ReverseToggleBtn.Font = Enum.Font.GothamBold; ReverseToggleBtn.TextSize = 12; Instance.new("UICorner", ReverseToggleBtn).CornerRadius = UDim.new(0, 6)
ReverseKeyBtn = Instance.new("TextButton", ReverseMain); ReverseKeyBtn.Size = UDim2.new(0, 50, 0, 45); ReverseKeyBtn.Position = UDim2.new(1, -60, 0, 45); ReverseKeyBtn.BackgroundColor3 = Color3.fromRGB(40, 40, 40); ReverseKeyBtn.Text = "KEY"; ReverseKeyBtn.TextColor3 = tWhite; ReverseKeyBtn.Font = Enum.Font.GothamBold; ReverseKeyBtn.TextSize = 11; Instance.new("UICorner", ReverseKeyBtn).CornerRadius = UDim.new(0, 6)
...
ReverseMinBtn.MouseButton1Click:Connect(function()
    reverseMinimized = not reverseMinimized; ReverseMain:TweenSize(reverseMinimized and UDim2.new(0, 260, 0, 35) or UDim2.new(0, 260, 0, 100), Enum.EasingDirection.Out, Enum.EasingStyle.Quint, 0.3, true)
    ReverseMinBtn.Text = reverseMinimized and "+" or "—"; ReverseFix.Visible = not reverseMinimized
end)

local isReverseActive = false; local reverseKeybind = nil; local isReverseBinding = false
...
local function ToggleReverse()
    ...
    if isReverseActive then
        ReverseToggleBtn.BackgroundColor3 = tCyan; ReverseToggleBtn.TextColor3 = Color3.fromRGB(10, 10, 10); ReverseToggleBtn.Text = "REVERSE: ON"; frames = {}
        RunService:BindToRenderStep(flashbackName, 1, function()
            local char = LocalPlayer.Character; if not char then return end
            local hrp = char:FindFirstChild("HumanoidRootPart"); local hum = char:FindFirstChildOfClass("Humanoid")
            if not hrp or not hum then return end
            if reverseKeybind and UserInputService:IsKeyDown(reverseKeybind) then
        ...
        ReverseToggleBtn.BackgroundColor3 = Color3.fromRGB(30, 30, 30); ReverseToggleBtn.TextColor3 = tWhite; ReverseToggleBtn.Text = "REVERSE: OFF"
...
ReverseCloseBtn.MouseButton1Click:Connect(function() 
    ReverseMain.Visible = false; reverseKeybind = nil; isReverseBinding = false; ReverseKeyBtn.Text = "KEY"; ReverseKeyBtn.BackgroundColor3 = Color3.fromRGB(40, 40, 40) 
