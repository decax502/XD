...
-- ==================================================================
-- LÓGICA DE GRAVEDAD Y MENÚ PROJECT SAFE (AÑADIR AL FINAL DEL SCRIPT)
-- ==================================================================
local PLAYERS = game:GetService("Players")
local UserInputService = game:GetService("UserInputService")
local LocalPlayer = PLAYERS.LocalPlayer
...
local function GetGravityUp(self, oldGravityUp)
	...
	for i = 1, NUM_DOWN_RAYS do
		...
		if (hit) then
			...
			if isEvenRay then evenRayHitCount = evenRayHitCount + 1 else oddRayHitCount = oddRayHitCount + 1 end
		end
	end
...
ToggleBtn.MouseButton1Click:Connect(ToggleGravity)

KeyBtn.MouseButton1Click:Connect(function()
    if gravKeybind ~= nil then
        gravKeybind = nil
        KeyBtn.Text = "KEY"
        KeyBtn.BackgroundColor3 = Color3.fromRGB(40, 40, 40)
        isBinding = false
...
CloseBtn.MouseButton1Click:Connect(function()
    if isGravityActive then ToggleGravity() end
    ScreenGui:Destroy()
end)
